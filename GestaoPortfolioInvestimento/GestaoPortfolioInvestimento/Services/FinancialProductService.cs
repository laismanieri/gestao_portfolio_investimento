...
namespace InvestmentPortfolioManagement.Services
{
    public class FinancialProductService : IFinancialProductService
    {
        ...
        public FinancialProduct AddFinancialProduct(FinancialProductDTO productDto)
        {
            if (productDto == null)
            {
            ...
            var newProduct = new FinancialProduct
            {
        ...
        public List<FinancialProduct> GetAllFinancialProducts(int skip, int take)
        {
